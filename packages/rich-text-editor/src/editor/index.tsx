...
import { TableMenu } from "@/editor/menus/table-menu";
import { TiptapExtensions } from "@/editor/extensions";
import { EditorBubbleMenu } from "@/editor/menus/bubble-menu";
import { ImageResizer } from "@/editor/extensions/image/image-resize";
...
const RichTextEditorWithRef = forwardRef<EditorHandle, ITiptapEditor>(
  (props, ref) => <RichTextEditor {...props} forwardedRef={ref} />
);

RichTextEditorWithRef.displayName = "TiptapEditorWithRef";
